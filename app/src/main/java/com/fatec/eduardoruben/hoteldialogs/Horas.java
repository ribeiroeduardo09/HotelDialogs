...
public class Horas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView lista = (ListView) findViewById(R.id.listaHoras);
        ...
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this, R.array.horas, android.R.layout.simple_list_item_1);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    dlg.setMessage("What time is breakfast served?");
                    dlg.show();
                    ...
                    mediaPlayer = MediaPlayer.create(Horas.this, resID);
                    mediaPlayer.start();
                ...
                if (position == 1) {
                    ...
                    dlg.setMessage("What time is lunch served?");
                    dlg.show();
                ...
                if (position == 2) {
                    ...
                    dlg.setMessage("What time is dinner served?");
                    dlg.show();
